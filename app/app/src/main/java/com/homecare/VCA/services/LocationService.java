...
public class LocationService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        startService(new Intent(LocationService.this,GeofenceService.class));
    ...
    private Task<Void> updateUserLocation() {
        if (mCurrentLocation != null) {
            ...
            if(!localUser.isCoordinatesSet()){
                mUserRef.update(
                                "geoFence.latitude", mCurrentLocation.getLatitude(),
                                "geoFence.longitude", mCurrentLocation.getLongitude()
                        );
            ...
            Log.i(TAG,"current position" + mCurrentLocation);
            ...
            return this.mFirestore.runTransaction(new Transaction.Function<Void>() {
                ...
                public Void apply(Transaction transaction) throws FirebaseFirestoreException {
                    // Commit to Firestore
                    transaction.set(geoRef, localUser.getGeo());
                    return null;
                }
            });
        }
